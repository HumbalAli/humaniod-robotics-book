...
const Chatbot: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([import React, { useState, useRef, useEffect } from 'react';
import clsx from 'clsx';
import styles from './Chatbot.module.css';
...
const Chatbot: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Sending request to backend:', { message: inputValue, user_id: 'website_user' });
      ...
      if (response.ok) {
        ...
        const botMessage: Message = {
          id: Date.now().toString(),
          content: data.response || data.answer || "I don't know.",
          role: 'assistant',
          timestamp: new Date(),
        };
        ...
        const fallbackMessage: Message = {
          id: Date.now().toString(),
          content: `I'm sorry, I couldn't process your question. Status: ${response.status}. The RAG backend might not be running.`,
          role: 'assistant',
          timestamp: new Date(),
        };
